...
#import "LevelTwentyThree.h"
#import "LevelsView.h"

@interface LevelTwentyThree ()

@end

@implementation LevelTwentyThree
...
-(IBAction)sendStart:(id)sender{
    ...
    MainInt2 = 0;
    timer2 = [NSTimer scheduledTimerWithTimeInterval: 0.06 target:self selector:@selector(countup2) userInfo:nil repeats:YES];
...
-(IBAction)sendStop:(id)sender{
    ...
    if(MainInt == ranNumber ){
        ...
        if ([incrementNumberLabel2.text isEqualToString:@"PASS"]){
            ...
            MainInt2 = 0;
            timer2 = [NSTimer scheduledTimerWithTimeInterval: 0.06 target:self selector:@selector(countuplast2) userInfo:nil repeats:YES];
            
            buttonFlipTimer2 = [NSTimer scheduledTimerWithTimeInterval: 0.12 target:self selector:@selector(buttonFlipCount2) userInfo:nil repeats:YES];
            
            ranNumber2 = [self getRandomNumberBetweenMin:500 andMax:1000];
