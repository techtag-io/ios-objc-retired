...
@interface LevelTwentyFive : UIViewController{
    ...
    NSTimer *timer2; //timer to time the incrementing number
    int MainInt2; //integer to be incremented
    
    NSTimer *timer3; //timer to time the incrementing number
    int MainInt3; //integer to be incremented
    ...
    UIButton *stopButton;
    UIButton *stopButton2;
    UIButton *stopButton3;
}
...
-(void)countup3; // code to increment the numbers
